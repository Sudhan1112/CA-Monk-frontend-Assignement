    ...
    const mutation = useMutation({
        ...
        onSuccess: () => {
            ...
            toast.success('Blog created successfully!', {
                ...
                icon: (
                    <div className="animate-bounceIn bg-green-100 rounded-full p-1">
                        <svg
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Textarea
                                            ...
                                            {...field}
                                            className="bg-white border-gray-300 text-gray-900 placeholder:text-gray-400 focus:border-black focus:ring-black min-h-20"
                                        />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Textarea
                                            ...
                                            {...field}
                                            className="bg-white border-gray-300 text-gray-900 placeholder:text-gray-400 focus:border-black focus:ring-black min-h-40"
                                        />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
