...
export default function Sidebar({ open, onClose, activeCategory, onCategoryChange }: SidebarProps) {
  const categories = [
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static w-64 h-screen bg-sidebar border-r border-sidebar-border flex flex-col transition-transform duration-300 z-50 ${
      ...
      >
        ...
        <div className="p-4 border-t border-sidebar-border space-y-2">
          <button 
            ...
            className="w-full flex items-center gap-3 px-3 py-2 rounded-md text-sidebar-foreground hover:bg-sidebar-accent transition-colors text-sm"
          >
