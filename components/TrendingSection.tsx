...
const trendingNews = [
  {
    ...
    views: '24.5K',
    image:
      'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=150&h=100&fit=crop',
  },
  {
    id: 2,
    category: 'Health',
    ...
    views: '18.2K',
    image:
      'https://images.unsplash.com/photo-1505228395891-9a51e7e86e81?w=150&h=100&fit=crop',
  },
  {
    id: 3,
    category: 'Business',
    ...
    views: '15.8K',
    image:
      'https://images.unsplash.com/photo-1560958089-b8a63c0c3efb?w=150&h=100&fit=crop',
  },
  {
    id: 4,
    category: 'Food',
  ...
  },
  {
    ...
    views: '9.8K',
    image:
      'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=150&h=100&fit=crop',
  },
];
...
export default function TrendingSection() {
  ...
  const handleTrendingNewsClick = (title: string) => {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-lg border border-border overflow-hidden">
        <div className="flex items-center justify-between p-4 border-b border-border">
          ...
          <button 
            onClick={() => handleViewAll('Trending News')}
        ...
        <div className="divide-y divide-border">
          {trendingNews.map((news, index) => (
            <div
              key={news.id}
              onClick={() => handleTrendingNewsClick(news.title)}
              className="flex gap-3 p-4 hover:bg-muted transition-colors cursor-pointer group"
            >
              {/* Image */}
      ...
      <div className="bg-card rounded-lg border border-border overflow-hidden">
        <div className="flex items-center justify-between p-4 border-b border-border">
          ...
          <button 
            onClick={() => handleViewAll('Trending Sections')}
            className="text-primary text-sm font-semibold hover:underline transition-colors"
          >
            →
          </button>
        ...
        <div className="divide-y divide-border">
          {trendingSections.map((section) => (
            <div
              ...
              className="flex items-center justify-between px-4 py-3 hover:bg-muted transition-colors cursor-pointer group"
            >
      ...
      <div className="bg-card rounded-lg border border-border p-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <button 
            onClick={() => handleViewAll('Popular Tags')}
            className="text-primary text-sm font-semibold hover:underline transition-colors"
          >
            +
          </button>
